...
<meta property="og:title" content="Using Python in FME: WorkspaceRunner and fmeobjects">
<meta property="og:description" content="Learn how to use Python in FME with WorkspaceRunner and fmeobjects.">
<meta property="og:type" content="article">
<meta property="og:url" content="https://yourwebsite.com/path/to/page">
<meta property="og:image" content="https://yourwebsite.com/path/to/image.jpg">
<h1 class="entry-title">Using Python in FME: WorkspaceRunner and&nbsp;fmeobjects</h1>
<style>
      canvas {
      display: block;
      margin: auto;
